...
namespace MusicPlayer.UWP.Pages.Artists
{
    ...
    public sealed partial class ArtistEditPage : Page
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Controllers.Image.Result image = await imageController.Get(artist.ImageId);
        ...
        private async void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            await artistController.Update(elementID.Value, name, surname, pseudonym, birth, description, bandId, image_id);
